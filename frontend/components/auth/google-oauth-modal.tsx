              ...
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-blue-50/60 dark:bg-blue-950/20 border border-blue-200/60 dark:border-blue-800/40">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="flex items-center gap-0.5 text-[9px] font-mono px-1.5 py-0.2 rounded bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300 font-bold">
