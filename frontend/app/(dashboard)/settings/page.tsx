      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-6 shadow-xs">
          ...
          <form onSubmit={handleSave} className="space-y-4 max-w-lg text-xs">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 p-2.5 text-slate-900 dark:text-white focus:outline-hidden focus:border-blue-500"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 p-2.5 text-slate-900 dark:text-white focus:outline-hidden focus:border-blue-500 font-mono"
              />
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                type="submit"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold shadow-xs transition-colors"
              >
        ...
        {activeTab === "appearance" && (
          <div className="space-y-5 max-w-2xl text-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="p-2 rounded-lg bg-slate-900 text-blue-400 shadow-xs">
                      <Moon className="h-4 w-4" />
                    </div>
                    <span className="font-bold text-slate-900 dark:text-white">Dark Slate</span>
                  </div>
                  {theme === "dark" && (
                    <span className="text-blue-600 dark:text-blue-400 font-mono font-bold text-xs">✓ Active</span>
                  )}
                </div>
            ...
            <div className="p-3.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-950 text-slate-600 dark:text-slate-400 text-xs flex items-center justify-between">
              <span>Active Rendered Scheme: <strong className="font-mono text-blue-600 dark:text-blue-400 uppercase">{resolvedTheme} MODE</strong></span>
              <button
                type="button"
                onClick={() => setTheme(resolvedTheme === "dark" ? "light" : "dark")}
                className="px-3 py-1 rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 font-medium hover:border-blue-500 transition-colors"
              >
                Quick Flip
              </button>
            </div>
        ...
        {activeTab === "privacy" && (
          <div className="space-y-3 max-w-lg text-xs">
            ...
            <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 text-blue-700 dark:text-blue-400">
        ...
        {activeTab === "security" && (
          <div className="space-y-3 max-w-lg text-xs">
            ...
            <div className="p-3 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 font-mono text-[11px] text-blue-700 dark:text-blue-400">
