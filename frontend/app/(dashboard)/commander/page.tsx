          ...
          {companies.map((coy) => {
            ...
            return (
              <div
                ...
                className={`p-3.5 rounded-lg border transition-all cursor-pointer ${
                  selectedCoy === coy.name
                    ? "border-blue-500 bg-blue-50/40 dark:bg-slate-900 ring-1 ring-blue-500/50"
              ...
              >
                ...
                <div className="mt-2 text-[9px] font-mono font-medium text-blue-600 dark:text-blue-400">
                  ● {coy.status}
                </div>
              </div>
            );
      ...
      <div className="rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#0F172A]/90 p-5 shadow-xs space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          {MOCK_EXECUTIVE_INSIGHTS.map((insight) => (
            ...
            >
              <span className="text-[10px] font-mono font-medium uppercase text-blue-600 dark:text-blue-400">
                ● {insight.category}
              </span>
