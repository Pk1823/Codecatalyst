            ...
            <ol className="space-y-2.5 list-decimal list-inside text-[11px] leading-relaxed">
              <li>
                <span className="font-medium text-slate-800 dark:text-slate-200">
                  {isHi ? "तुरंत मूल्यांकन खोलें" : "Instant Browser Access"}:
                </span>{" "}
                {isHi ? "क्यूआर कोड स्कैन करें अथवा नीचे दिए गए बटन से सीधे मूल्यांकन शुरू करें।" : "Scan the QR code or click Launch Assessment below to start instantly."}
              </li>
              <li>
                <span className="font-medium text-slate-800 dark:text-slate-200">
