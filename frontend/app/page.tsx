...
export default function LandingPage() {
  ...
  const { force, lang, toggleLang } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#090D16] text-slate-900 dark:text-slate-100 selection:bg-emerald-500/20 selection:text-emerald-700 dark:selection:text-emerald-300 flex flex-col font-sans transition-colors duration-200">
      {/* Top Header */}
      <header className="sticky top-0 z-40 w-full border-b border-slate-200 dark:border-slate-800/80 bg-white/90 dark:bg-[#090D16]/90 backdrop-blur-md">
        <div className="max-w-6xl mx-auto flex h-16 items-center justify-between px-4 sm:px-6">
          ...
          <nav className="hidden md:flex items-center gap-6 text-xs font-medium text-slate-600 dark:text-slate-300">
            <a href="#how-it-works" className="hover:text-emerald-600 dark:hover:text-white transition-colors">
              {isHi ? "कार्यप्रणाली" : "How It Works"}
            </a>
            <a href="#features" className="hover:text-emerald-600 dark:hover:text-white transition-colors">
              {isHi ? "मुख्य विशेषताएं" : "Key Capabilities"}
            </a>
            <a href="#privacy" className="hover:text-emerald-600 dark:hover:text-white transition-colors">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={toggleTheme}
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-900 text-xs font-mono font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors shadow-xs"
            ...
            <button
              onClick={toggleLang}
              className="px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-900 text-xs font-mono font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors shadow-xs"
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white px-3.5 py-1.5 text-xs sm:text-sm font-semibold shadow-xs transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
      ...
      <section className="relative pt-16 pb-20 lg:pt-24 lg:pb-28 border-b border-slate-200 dark:border-slate-800/80 overflow-hidden bg-tactical-grid">
        {/* Ambient Subtle Glow */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-6">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/20 bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 text-xs font-mono">
            <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
            <span>SIH 2024 Problem Statement 26186 • MHA / CAPF Directorate</span>
          </div>

          {/* Value Prop Headline */}
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 dark:text-[#F8FAFC] leading-tight">
            {isHi ? (
              <>
                ड्यूटी तनाव और थकान की{" "}
                <span className="text-emerald-600 dark:text-emerald-400">समय रहते पहचान</span>
              </>
            ) : (
              <>
                Early stress & fatigue detection for{" "}
                <span className="text-emerald-600 dark:text-emerald-400">safer, resilient forces</span>
              </>
            )}
          </h1>
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/login"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-600/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
            ...
            <a
              href="#how-it-works"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 dark:border-slate-700/80 bg-white dark:bg-slate-900/60 hover:bg-slate-100 dark:hover:bg-slate-800 px-5 py-3 text-sm font-medium text-slate-800 dark:text-slate-200 transition-all shadow-xs"
            >
          ...
          {/* Trust Highlights */}
          <div className="pt-8 flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800/60 mt-8">
            <div className="flex items-center gap-1.5">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Tele-MANAS: <strong className="text-slate-900 dark:text-slate-200 font-mono">14416</strong></span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-20 bg-white dark:bg-[#090D16] border-b border-slate-200 dark:border-slate-800/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-14 space-y-2">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-[#F8FAFC] tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Step 1 */}
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/70 dark:bg-[#0F172A]/80 p-6 flex flex-col justify-between shadow-xs hover:shadow-md transition-all">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <HeartPulse className="h-5 w-5 text-emerald-600 dark:text-slate-400" />
                </div>
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/70 dark:bg-[#0F172A]/80 p-6 flex flex-col justify-between shadow-xs hover:shadow-md transition-all">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Brain className="h-5 w-5 text-blue-600 dark:text-slate-400" />
                </div>
                <h4 className="text-base font-bold text-slate-900 dark:text-white">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/70 dark:bg-[#0F172A]/80 p-6 flex flex-col justify-between shadow-xs hover:shadow-md transition-all">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Zap className="h-5 w-5 text-amber-500 dark:text-slate-400" />
                </div>
                <h4 className="text-base font-bold text-slate-900 dark:text-white">
      ...
      <section id="features" className="py-20 bg-slate-50/50 dark:bg-[#090D16] border-b border-slate-200 dark:border-slate-800/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F172A]/90 p-6 flex gap-4 shadow-xs">
              <div className="p-2.5 rounded-lg bg-emerald-50 dark:bg-slate-800 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-slate-700 shrink-0 h-fit">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  {isHi
                    ...
                    : "Uniformed personnel rarely admit vulnerability. Cross-validation between duty logs and sleep patterns uncovers hidden strain."}
                </p>
              </div>
            </div>
            ...
            {/* Pillar 2: Buddy-Pair */}
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F172A]/90 p-6 flex gap-4 shadow-xs">
              <div className="p-2.5 rounded-lg bg-blue-50 dark:bg-slate-800 text-blue-600 dark:text-sky-400 border border-blue-200 dark:border-slate-700 shrink-0 h-fit">
                <Users className="h-5 w-5" />
              </div>
              <div>
                <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">
                  {isHi ? "बडी-पेयर पारस्परिक सुरक्षा" : "Operational Buddy-Pair System"}
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  {isHi
                    ? "सशस्त्र बलों की सदियों पुरानी 'जोड़ीदार' प्रथा को डिजिटल शक्ति प्रदान करता है, ताकि साथी जवान समय पर सहायता मांग सके।"
                    : "Leverages the traditional armed forces 'buddy' concept, empowering peers to discreetly trigger rest without shame."}
                </p>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F172A]/90 p-6 flex gap-4 shadow-xs">
              <div className="p-2.5 rounded-lg bg-purple-50 dark:bg-slate-800 text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-slate-700 shrink-0 h-fit">
                <Lock className="h-5 w-5" />
              </div>
              <div>
                <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">
                  {isHi ? "शून्य एसीआर पूर्वग्रह गारंटी" : "Zero ACR/APAR Prejudice Guarantee"}
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  {isHi
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F172A]/90 p-6 flex gap-4 shadow-xs">
              <div className="p-2.5 rounded-lg bg-amber-50 dark:bg-slate-800 text-amber-600 dark:text-amber-400 border border-amber-200 dark:border-slate-700 shrink-0 h-fit">
      ...
      <section id="privacy" className="py-20 bg-white dark:bg-[#090D16] border-b border-slate-200 dark:border-slate-800/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-6">
          <div className="text-center max-w-xl mx-auto space-y-2">
            ...
            <h3 className="text-2xl font-bold text-slate-900 dark:text-[#F8FAFC] tracking-tight">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F172A]/90 p-5 shadow-lg overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs font-mono">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60 text-slate-700 dark:text-slate-300">
                  <tr>
                    <td className="py-3 px-3 font-sans font-medium text-slate-900 dark:text-slate-200">{isHi ? "स्वैच्छिक चेक-इन व बडी रिपोर्ट" : "Self-Report & Buddy Feedback"}</td>
                    <td className="py-3 px-3 text-center text-emerald-600 dark:text-emerald-400 font-bold">✓ Full Access</td>
                    <td className="py-3 px-3 text-center text-emerald-600 dark:text-emerald-400 font-bold">✓ Care Triage</td>
                    <td className="py-3 px-3 text-center text-rose-600 dark:text-rose-400 font-bold">✕ BLOCKED</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-3 font-sans font-medium text-slate-900 dark:text-slate-200">{isHi ? "चिकित्सा परामर्श नोट्स" : "Counseling Clinical Notes"}</td>
                    <td className="py-3 px-3 text-center text-slate-400">—</td>
                    <td className="py-3 px-3 text-center text-emerald-600 dark:text-emerald-400 font-bold">✓ Doctor-Only</td>
                    <td className="py-3 px-3 text-center text-rose-600 dark:text-rose-400 font-bold">✕ BLOCKED</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-3 font-sans font-medium text-slate-900 dark:text-slate-200">{isHi ? "कंपनी तनाव व तत्परता सूचकांक" : "Unit Stress & Readiness Index"}</td>
                    <td className="py-3 px-3 text-center text-slate-400">—</td>
                    <td className="py-3 px-3 text-center text-emerald-600 dark:text-emerald-400 font-bold">✓ Aggregated</td>
                    <td className="py-3 px-3 text-center text-emerald-600 dark:text-emerald-400 font-bold">✓ Masked Summary</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <section className="py-16 bg-slate-50/70 dark:bg-[#090D16] text-center border-b border-slate-200 dark:border-slate-800/80">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 space-y-5">
          ...
          <div className="pt-2 flex items-center justify-center">
            <Link
              href="/login"
              className="inline-flex items-center gap-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-emerald-600/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
      ...
      <footer className="bg-slate-100 dark:bg-[#060910] py-6 text-slate-600 dark:text-slate-400 text-xs border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-slate-700 dark:text-slate-400">
            <Shield className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />
            <span className="font-semibold text-slate-900 dark:text-slate-200">MissionWell AI</span>
          ...
          <div className="text-slate-600 dark:text-slate-400 text-center sm:text-right font-mono text-[11px]">
            <span>24x7 Helpline: <strong className="text-emerald-600 dark:text-emerald-400 font-medium">14416</strong> • KIRAN: <strong className="text-emerald-600 dark:text-emerald-400 font-medium">1800-599-0019</strong></span>
          </div>
        </div>
      </footer>
    </div>
